...
**AmazonGPT** is compatible w/ the following browsers (create a [pull request](https://github.com/KudoAI/amazongpt/pulls) or [issue](https://github.com/KudoAI/amazongpt/issues/new) to add more tested working ones):
