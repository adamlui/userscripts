...
If you've tested it to work in a browser not listed, simply create a [pull request](https://github.com/KudoAI/amazongpt/pulls) or [issue](https://github.com/KudoAI/amazongpt/issues/new) to become a contributor!
<br><br>
