...
2. Install [Auto-Clear ChatGPT History](/) (will load in userscript manager installed above)

3. Visit [chat.openai.com](https://chat.openai.com) as normal & chat history is auto-cleared!

## Compatibility

Auto-Clear ChatGPT History is compatible with Chrome, Firefox, Edge, Opera, Brave & Vivaldi using Tampermonkey or Violentmonkey. ([Pull requests](https://github.com/adamlui/userscripts/pulls) always welcome!)
