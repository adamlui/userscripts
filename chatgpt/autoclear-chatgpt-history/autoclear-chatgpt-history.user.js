...
(async () => {
    ...
    function clearChatsAndGoHome() {
        ...
        new Promise(resolve => setTimeout(resolve, 1000)).then(() => {
            ...
            if (!clearChatsAndGoHome.observer) { // monitor <nav> to restore temporal headings on new chats
                clearChatsAndGoHome.observer = new MutationObserver(mutations => mutations.forEach(mutation => {
                ...
                clearChatsAndGoHome.observer.observe(document.querySelector('nav'), { childList: true, subtree: true })
            }
        })
