...
(async () => {
    ...
    window.app = {
        ...
        commitHashes: { app: '30f0b15' } // for cached <app|messages>.json + navicon in toggles.sidebar.insert()
    }
        ...
        sidebar: {
            ...
            update: {
                ...
                state() {
                    ...
                    const isOn = toggles.sidebar.toggleInput.checked = config.autoclear
