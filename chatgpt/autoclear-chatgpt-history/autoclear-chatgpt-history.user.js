...
(async () => {
    ...
    const settings = {
        ...
        controls: { // displays top-to-bottom in toolbar menu
            autoclear: { type: 'toggle', label: app.msgs.menuLabel_autoclear, helptip: app.msgs.appDesc },
            clearNow: { type: 'action', symbol: '🧹', label: app.msgs.menuLabel_clearNow, helptip: app.msgs.helptip_clearNow },
    ...
    function clearChatsAndGoHome() {
        ...
        new Promise(resolve => setTimeout(resolve, 1000)).then(() => {
            ...
            if (!clearChatsAndGoHome.historyObserver) { // monitor sidebar to restore temporal headings on new chats
                ...
                clearChatsAndGoHome.historyObserver.observe(document.querySelector('nav'), { childList: true, subtree: true })
            }
        })
