...
// @resource bsbgCSS    https://cdn.jsdelivr.net/gh/adamlui/autoclear-chatgpt-history@1f292f3/assets/styles/css/black-rising-stars.min.css#sha256-RIkvVcaRwwWHMluYKcYeIr1txKkGItLXvdhFo673ST8=
// @resource wsbgCSS    https://cdn.jsdelivr.net/gh/adamlui/autoclear-chatgpt-history@1f292f3/assets/styles/css/white-rising-stars.min.css#sha256-/cdMEDsWGfHzDc5rkoD2UGCHtiZme+z9fjkSgV2Z7No=
// @grant               GM_setValue
// @grant               GM_getValue
...
(async () => {
    ...
    const sidebarToggle = {
        ...
        insert() {
            if (sidebarToggle.status?.startsWith('insert') || document.getElementById('autoclear-toggle-navicon'))
                return
