<div align="right">
    <h6>
        ...
        &nbsp;हिंदी |
        <a href="https://github.com/adamlui/autoclear-chatgpt-history/blob/main/docs/LICENSE.md">English</a>
    </h6>
</div>

# 🏛️ MIT लाइसेंस

**कॉपीराइट © 2023–2026 [एडम लुई (Adam Lui)](https://github.com/adamlui) और [योगदानकर्ता](https://github.com/adamlui/autoclear-chatgpt-history/#-contributors)**
