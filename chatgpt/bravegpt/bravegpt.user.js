...
(async () => {
    ...
    const update = {
        ...
        scheme(newScheme) {
            ...
            env.ui.app.scheme = newScheme ; logos.braveGPT.update() ; update.style.app() ; modals.stylize()
    ...
    const show = {
        ...
        reply(answer) {
            ...
            if (!appDiv.querySelector('pre')) {
                ...
                settingsBtn.className = 'corner-btn' ; settingsBtn.style.margin = '1.5px 9px 0 1px'
    ...
    const appDivParent = await new Promise(resolve => {
        ...
        if (appDivParent) resolve(container)
