...
(async () => {
    ...
    const app = {
        ...
        latestResourceCommitHash: 'aa3057a' // for cached messages.json
    }
        ...
        appStyle() {
            ...
            app.styles.innerText = (
              ...
              + `#${app.slug} > pre {`
                  ...
                  + 'margin-top: 12px ; padding: 1.2em 1.2em 0 1.2em ; border-radius: 0 0 13px 13px ; overflow: auto ;'
              ...
              + `#${app.slug}-pre-header {
                    ...
                    top: 12px ; padding: 16px 14px ; height: 18px ; border-radius: 13px 13px 0 0 ;
                ...
                .${app.slug}-pre-header-btns { margin: 10.5px -5px 0 }`
        ...
        // * stateOrEvent: 'on'|'off' or button `event`
            ...
            tooltipDiv.style.top = `${
              ...
              : answerBubble.buttons.types.includes(btnType) && !stateOrEvent.currentTarget.closest('code') ?
                   36 + ( rects.fsSlider?.height > 0 ? rects.fsSlider.height -16 : 0 )
