...
// @require               https://cdn.jsdelivr.net/gh/adamlui/ai-web-extensions@b1e28ff/assets/js/lib/chatbot/userscript.js#sha256-SytCWuD3YOcYFDaVfpF8Pq67zDbV8cZcIENz+0zpZ40=// @require
...
(async () => {
    ...
    window.app = {
        ...
        commitHashes: {
            app: 'b62177e', // for cached <app|messages>.json
    ...
    const ui = {
        ...
        visibilizeOverflow() { // for boundless hover fx
