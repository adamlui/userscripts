...
// @require             https://cdn.jsdelivr.net/gh/adamlui/userscripts@797b7c4/assets/js/lib/css.js/dist/css.min.js#sha256-aXqYP++UytsFlx7716x6Svtxf6Sw73W0zkeKguwkzg0=
// @require             https://cdn.jsdelivr.net/gh/adamlui/userscripts@797b7c4/assets/js/lib/dom.js/dist/dom.min.js#sha256-79blMCWr6U2rzsvzBpx7xvh48zDh8DEeZzGguc9XOHQ=
...
// @noframes
// @downloadURL         https://raw.githubusercontent.com/adamlui/chatgpt-auto-refresh/refs/heads/main/greasemonkey/chatgpt-auto-refresh.user.js
// @updateURL           https://raw.githubusercontent.com/adamlui/chatgpt-auto-refresh/refs/heads/main/greasemonkey/chatgpt-auto-refresh.user.js
// @homepageURL         https://github.com/adamlui/chatgpt-auto-refresh/#readme
// @supportURL          https://github.com/adamlui/chatgpt-auto-refresh/issues
// @contributionURL     https://ko-fi.com/adamlui
// ==/UserScript==

// Documentation: https://github.com/adamlui/chatgpt-auto-refresh/tree/main/docs
...
(async () => {
    ...
    window.app = {
        ...
        commitHashes: { app: '225c773' } // for cached <app|messages>.json
    }
    app.urls = {
                ...
                return GM_registerMenuCommand(menuLabel, () => {
                    if (entryData.type == 'toggle') {
                        ...
                        if (refreshInterval == null) return // user cancelled so do nothing
                            ...
                            this.refresh()
                            const minInt = Math.max(2, app.config.refreshInterval -10),
                                  maxInt = app.config.refreshInterval +10
                            modals.alert(`${app.msgs.alert_intUpdated}!`,
                                `${app.msgs.alert_willRefresh} ${minInt}–${maxInt} ${app.msgs.unit_secs}`)
                        }
                    }
    ...
    function syncConfigToUI({ updatedKey } = {}) {
        if (updatedKey == 'arDisabled') toggleAutoRefresh()
        if (/arDisabled|toggleHidden/.test(updatedKey)) toggles.sidebar.update.state()
