...
(async () => {
    ...
    const sidebarToggle = {
        ...
        update() {
            ...
            toggleLabel.innerText = `${app.msgs.mode_autoRefresh} ${
    ...
    new MutationObserver(() => {
        if (!config.toggleHidden && !document.getElementById('auto-refresh-toggle-navicon') && sidebarToggle.status != 'inserting') {
