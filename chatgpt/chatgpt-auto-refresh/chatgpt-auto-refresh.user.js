...
// @homepageURL         https://chatgptautorefresh.com
...
(async () => {
    ...
    window.app = {
        ...
        commitHashes: { app: 'e187e2c' } // for cached <app|messages>.json
    }
    app.urls = {
        ...
        sidebar: {
            ...
            update: {
                ...
                state() {
                    ...
                    const isOn = toggles.sidebar.toggleInput.checked = !config.arDisabled
