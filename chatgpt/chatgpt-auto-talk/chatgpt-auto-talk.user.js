...
(async () => {
    ...
    Object.assign(chatgpt.selectors, {
        btns: {
            ...
            moreOptions: 'button:has(> svg > use[href*="#f6d0e2"])',
            play: 'div[data-testid*=voice-play]:has(svg use[href$="sprites-core-k5zux585.svg#54f145"])',
            stop: 'div[data-testid*=voice-play]:has(svg use[href$="sprites-core-k5zux585.svg#f64f60"])'
        },
