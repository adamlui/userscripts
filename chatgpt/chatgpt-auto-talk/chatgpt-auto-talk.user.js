    ...
    const message = {
        ...
        outline: {
            ...
            show(targetNode) {
                ...
                this.color ||= chatgpt.isDarkMode() ? 'rgba(223, 225, 227, 0.7)' : 'rgba(0, 157, 255, 0.7)'
                ...
                ;(this.pulseGlowKeyframes ||= dom.create.style()).textContent = `
                    @keyframes pulse-glow {
                        0%   { box-shadow: 0 0 0 0   ${this.color} }
                        50%  { box-shadow: 0 0 0 8px rgba(59, 130, 246, 0) }
                        100% { box-shadow: 0 0 0 0   rgba(59, 130, 246, 0) }
                    }`
                if (!this.pulseGlowKeyframes.isConnected) document.head.append(this.pulseGlowKeyframes)
            }
        },
