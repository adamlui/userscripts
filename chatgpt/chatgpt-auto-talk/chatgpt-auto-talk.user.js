...
(async () => {
    ...
    const app = {
        ...
        latestAssetCommitHash: '6eb8529' // for cached messages.json + navicon in toggles.sidebar.insert()
    }
    ...
    const toggles = {
        ...
        sidebar: {
            ...
            insert() {
                if (this.status?.startsWith('insert') || document.getElementById('auto-talk-toggle-navicon')) return
