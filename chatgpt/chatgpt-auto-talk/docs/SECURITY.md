<div align="right">
    <h6>
        ...
        &nbsp;English |
        <a href="https://github.com/adamlui/chatgpt-auto-talk/tree/main/docs/zh-cn/SECURITY.md">简体中文</a>
    </h6>
</div>

# 🛡️ Security Policy

If you find a vulnerability, please open a [draft security advisory](https://github.com/adamlui/chatgpt-auto-talk/security/advisories/new).
