...
// @require             https://cdn.jsdelivr.net/gh/adamlui/chatgpt-widescreen@f0ad538/chromium/extension/lib/styles.js#sha256-/XmRD6YE61G8xa5w6mxde6Qkrcl3/gumC9TTIM4kBG4=
...
(async () => {
    ...
    window.app = {
        ...
        commitHashes: { app: 'c4a8542' } // for cached <app|messages>.json + sites.json5
    }
    app.urls = {
