...
// @require             https://cdn.jsdelivr.net/gh/adamlui/chatgpt-widescreen@b087eae/chromium/extension/lib/styles.js#sha256-VHeB0/crxJuoqL9WMEIzC6JDWCzf3o3MYI+BeVDm1y4=
...
(async () => {
    ...
    window.app = {
        ...
        commitHashes: { app: '7e92a70' } // for cached <app|messages>.json + sites.json5
    }
    app.urls = {
        ...
        settings(ctgKey) { // for categories
            ...
            modals.settings.style.textContent = `
                ...
                .${app.slug}-settings-modal ul { /* entries list */
                    cursor: pointer ; font-size: 18px ; margin: 16px 0 -10px ${ env.site == 'poe' ? '-18px' : '' };
                    list-style: none
                }
            ...
            settingsModal.style.cssText +=
                `padding-bottom: 10px !important ; ${ env.site == 'poe' ? 'padding-left: 0 !important' : '' }`
