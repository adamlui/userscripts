...
DuckDuckGPT is compatible with Chrome, Firefox, Edge & Brave using Tampermonkey or Violentmonkey. ([Pull requests](https://github.com/adamlui/userscripts/pulls) always welcome!)
