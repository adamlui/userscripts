...
DuckDuckGPT is compatible with Chrome, Firefox, Edge, Brave, Opera, Vivaldi, LibreWolf & QQ using Tampermonkey (recommended due to streaming suppport resulting in faster responses) or Violentmonkey. ([Pull requests](https://github.com/adamlui/userscripts/pulls) always welcome!)
