...
(async () => {
    ...
    const app = {
        ...
        latestResourceCommitHash: '4cc8f14' // for cached messages.json
    }
    ...
    env.ui = {
        ...
        site: { isCentered: !!document.documentElement.className.includes('center'), scheme: getScheme() }
    }
        ...
        appStyle() {
            ...
            app.styles.innerText = (
              ...
              + ( // rendered markdown styles
                  ...
                  + `#${app.slug} > pre ol { margin: -26px 0 -20px 7px }`
    ...
    const toggle = {
        ...
        // * stateOrEvent: 'on'|'off' or button `event`
            ...
            tooltipDiv.style.top = `${
              ...
              : rects.btn.top - rects.appDiv.top -36 - ( stateOrEvent.currentTarget.closest('code') ? 5 : 0 )
            }px`
        ...
        replyCornerBtns() {
            ...
            appDiv.querySelectorAll(`#${app.slug} > pre, code`).forEach(parentElem => {
                ...
                if (parentElem.tagName == 'CODE') {
                    elemToPrepend = dom.create.elem('div', { style: 'height: 11px ; margin: 2px 3px 0 0' })
