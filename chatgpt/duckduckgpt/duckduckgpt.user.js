...
// @resource ddgptIcon     https://assets.ddgpt.com/images/icons/duckduckgpt/icon64.png.b64?v=8482c4b#sha256-k7hl9PAq+HAKG2vS9wlKmu3EEvdE3k2Z2KR/SRkk6D4=
...
// @resource ddgptDSlogo   https://assets.ddgpt.com/images/logos/duckduckgpt/darkmode/logo697x122.png.b64?v=8482c4b#sha256-lSd4M3RPT4+SjjBk8PKGFoyM9p3rZHgxt0NgoKqQkiM=// @resource hljsCSS       https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/styles/dark.min.css#sha256-v0N76BFFkH0dCB8bUr4cHSVN8A/zCaOopMuSmJWV/5w=
...
(async () => {
    ...
    const app = {
        ...
        configKeyPrefix: 'duckDuckGPT', slug: 'duckduckgpt',
    ...
    const apis = Object.assign(Object.create(null), await new Promise(resolve => xhr({
        method: 'GET', url: 'https://assets.aiwebextensions.com/data/ai-chat-apis.json?v=0467eb7',
    ...
    Object.assign(settings, { controls: { // displays top-to-bottom, left-to-right in Settings modal
        ...
        widerSidebar: { type: 'toggle', mobile: false, centered: false, icon: 'widescreen', defaultVal: false,
            label: app.msgs.menuLabel_widerSidebar,
            helptip: app.msgs.helptip_widerSidebar },
        stickySidebar: { type: 'toggle', mobile: false, centered: false, icon: 'webCorner', defaultVal: false,
    ...
    const update = {
        ...
        appStyle() {
            ...
            app.styles.innerText = (
              ...
              + `#${app.slug} + footer {
                    font-size: 13px ; color: #${ env.ui.scheme == 'dark' ? 'ccc' : 'aaa' } ; line-height: 1.25 ;
                    text-align: right ; display: grid ; width: 100% ; margin: 14px 0 25px ; position: relative }`
