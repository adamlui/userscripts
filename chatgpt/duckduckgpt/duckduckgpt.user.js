...
(async () => {
    ...
    const app = {
        ...
        latestResourceCommitHash: 'ad16dd2' // for cached app.json + messages.json
    }
        ...
        appStyle() { // used in toggle.animations() + update.scheme() + main's app init
            ...
            app.styles.innerText = (
              ...
              + `#${app.slug} .reply-tip {
                    ...
                    float: left ; left: 9px ; margin: 1px -13px 0 -1px ; /* positioning */
    ...
    const addListeners = {
        ...
        appDiv() {
            ...
            appDiv.onmouseenter = appDiv.onmouseleave = update.bylineVisibility
        },
