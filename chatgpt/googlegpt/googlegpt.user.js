...
// @version                  2025.8.8
// @license                  MIT
// @icon                     data:image/svg+xml,%3Csvg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="170.667" height="170.667"%3E%3Cstyle%3E :root { --fill: %23000 } @media (prefers-color-scheme: dark) { :root { --fill: %23fff } } %3C/style%3E%3Cpath fill="var(--fill)" d="M82.346 159.79c-18.113-1.815-31.78-9.013-45.921-24.184C23.197 121.416 17.333 106.18 17.333 86c0-21.982 5.984-36.245 21.87-52.131C55.33 17.74 69.27 11.867 91.416 11.867c17.574 0 29.679 3.924 44.309 14.363l8.57 6.116-8.705 8.705-8.704 8.704-4.288-3.608c-13.91-11.704-35.932-14.167-53.085-5.939-3.4 1.631-9.833 6.601-14.297 11.045C44.669 61.753 40.95 70.811 40.95 86c0 14.342 3.594 23.555 13.26 33.995 19.088 20.618 48.46 22.539 70.457 4.608l5.333-4.348 11.333 3.844c6.234 2.114 11.54 3.857 11.791 3.873.252.015-2.037 3.008-5.087 6.65-6.343 7.577-20.148 17.217-30.493 21.295-8.764 3.454-23.358 5.06-35.198 3.873zM92 86.333V74.667h60.648l-11.41 11.41-11.411 11.41-18.914.257L92 98z"%2F%3E%3C/svg%3E
// @icon64                   data:image/svg+xml,%3Csvg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="170.667" height="170.667"%3E%3Cstyle%3E :root { --fill: %23000 } @media (prefers-color-scheme: dark) { :root { --fill: %23fff } } %3C/style%3E%3Cpath fill="var(--fill)" d="M82.346 159.79c-18.113-1.815-31.78-9.013-45.921-24.184C23.197 121.416 17.333 106.18 17.333 86c0-21.982 5.984-36.245 21.87-52.131C55.33 17.74 69.27 11.867 91.416 11.867c17.574 0 29.679 3.924 44.309 14.363l8.57 6.116-8.705 8.705-8.704 8.704-4.288-3.608c-13.91-11.704-35.932-14.167-53.085-5.939-3.4 1.631-9.833 6.601-14.297 11.045C44.669 61.753 40.95 70.811 40.95 86c0 14.342 3.594 23.555 13.26 33.995 19.088 20.618 48.46 22.539 70.457 4.608l5.333-4.348 11.333 3.844c6.234 2.114 11.54 3.857 11.791 3.873.252.015-2.037 3.008-5.087 6.65-6.343 7.577-20.148 17.217-30.493 21.295-8.764 3.454-23.358 5.06-35.198 3.873zM92 86.333V74.667h60.648l-11.41 11.41-11.411 11.41-18.914.257L92 98z"%2F%3E%3C/svg%3E
// @compatible               brave
// @compatible               chrome
...
(async () => {
    ...
    window.update = {
        ...
        scheme(newScheme) {
            env.ui.app.scheme = newScheme ; logos.googlegpt.update() ; icons.app.googlegpt.update() ; update.appStyle()
