...
(async () => {
    ...
    const update = {
        ...
        appStyle() {
            ...
            app.styles.innerText = (
              ...
              //+ `#${app.cssPrefix}:not(.anchored) [id$=arrows-btn] { display: none !important }`
                            ...
                            for (const [campaignName, campaign] of shuffle(
                                ...
                                for (const [groupName, adGroup] of shuffle(
                                    ...
                                    const newFooterContent = destinationURL ?
                                        create.anchor(destinationURL, { class: 'anchored-hidden' })
    ...
    let footerContent = create.anchor('#', app.msgs.link_shareFeedback, { target: '_self', class: 'anchored-hidden' })
