    ...
    { ignores: ['**/*cache*', '**/*.min.{js,mjs}', '**/package-lock.json'] },
    {
        files: ['**/*.{js,mjs}'],
            ...
            globals: {
                ...
                get: 'readonly', GM_cookie: 'readonly', hljs: 'readonly', i18n: 'readonly', icons: 'writable',
                infinity: 'readonly', inputEvents: 'readonly', ipv4: 'readonly', JSON5: 'readonly', log: 'readonly',
                marked: 'readonly', menus: 'writable', modals: 'writable', msgChain: 'writable', notify: 'readonly',
                prompts: 'readonly', renderMathInElement: 'readonly', replyBubble: 'writable', session: 'readonly',
                settings: 'writable', show: 'readonly', sites: 'writable', string: 'readonly', styles: 'writable',
