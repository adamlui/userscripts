...
(async () => {
    ...
    async function fetchStarHistoryImgDataURL(user, repo) {
        ...
        const response = await new Promise((resolve, reject) => env.xhr({
    ...
    function createHoverSettingsPanel(starHistoryDiv, options = {}) {
        ...
        const buttonBottom = options.buttonBottom || '50px',
    ...
    GM_registerMenuCommand(`💡 About ${app.name}`, async () => {
        ...
        const aboutAlertID = ghAlert(
            ...
            [ // buttons
                ...
                function rateUs() { safeWinOpen(app.urls.review.scriptcat) }
            ], null, 549)
        ...
        for (const button of document.getElementById(aboutAlertID).querySelectorAll('button')) {
            ...
            else if (/rate/i.test(button.textContent))
                button.textContent = '⭐ Rate Us'
