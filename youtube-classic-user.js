...
styles.innerHTML=`
    ...
    yt-formatted-string#text.style-scope.ytd-button-renderer.style-destructive.size-default {
    letter-spacing: 0.5px;
    }
    ...
    yt-formatted-string.style-scope.ytd-toggle-button-renderer.style-default-active {
    letter-spacing: 0.5px;
    }
    ...
    div#icon-label.yt-dropdown-menu {
    letter-spacing: 0.5px;
    }
