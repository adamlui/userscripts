...
**版權所有 © 2023–2026 [劉展鵬 (Adam Lui)](https://github.com/adamlui), magma_craft & 貢獻者**

特此免費向任何獲得副本的人授予許可本軟體和相關文件文件（‘軟體’），處理在軟體中不受限制，包括但不限於權利使用、複製、修改、合併、發布、分發、再許可和/或出售該軟體的副本，並允許該軟體是提供這樣做，但須滿足以下條件：
